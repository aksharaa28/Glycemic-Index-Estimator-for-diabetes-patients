...
# 'Glucose' is the target column, so we drop it from X
...
joblib.dump(model, 'Gradient_boosting_model.pkl')  # Save the model as 'gradient_boosting_model.pkl'
print("Model saved to 'Gradient_boosting_model.pkl'")

# Load the saved model from the file to verify that it can be used for predictions
loaded_model = joblib.load('Gradient_boosting_model.pkl')
print("Model loaded from 'Gradient_boosting_model.pkl'")
